    ...
    <div className='Navbar p-3 px-6 h-[100px]  bg-slate-50 w-auto '>
        {
            ...
            <div className='flex justify-start'>
               ...
               <span className='py-2 ml-4 sm:block hidden'>
                ...
                <div className={`cursor-pointer transition-all duration-500 absolute bg-slate-200 w-64 ${!sideBar ? "left-[0rem]" : "left-[-20rem]" } h-full    m-0 top-0`}>
                    <div className='bg-red-900 h-52 flex'>
                        <span>Back</span>
                        
                    </div>
                    <div className='p-3 py-6'>
                        <p className='hover:bg-orange-200 rounded-xl transition-all duration-300 my-5'><i className="fa-solid fa-user font-bold text-2xl  p-5 rounded-full transition-all duration-200"></i></p>
                        <p className='hover:bg-orange-200 rounded-xl transition-all duration-300'><i className="fa-solid fa-wallet font-bold text-2xl  p-5 rounded-full transition-all duration-200"></i>Connect Your Wallet</p>
                    </div>
                </div>
