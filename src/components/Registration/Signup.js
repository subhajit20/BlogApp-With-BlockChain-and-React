      ...
      <div className='w-[17rem] sm:w-[30rem] h-[50rem] absolute top-0 z-[-1]  flex justify-center '>
        <form className='my-[5rem]'>
          <div>
            ...
            <input type="text" className='p-3 px-6 w-[15rem] sm:w-[27rem]  cursor-pointer my-2 outline-none rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] placeholder:text-black font-semibold' placeholder='Enter Username'/>   
          </div>
          ...
          <div>
            <i class="fa-solid fa-lock mr-4"></i>
            <input type="password" className='p-3 px-6 w-[15rem] sm:w-[27rem]  cursor-pointer my-2 outline-none rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] placeholder:text-black font-semibold' placeholder='Confirm Password '/>   
          </div>
          <span className='ml-10 text-red-700 text-lg font-semibold p-1'>Error</span>
