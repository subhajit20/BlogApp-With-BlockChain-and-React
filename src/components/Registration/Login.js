      ...
      <div className='w-[17rem] sm:w-[30rem] h-[50rem] absolute top-0 z-[-1]  flex justify-center '>
        <form className='my-[5rem]'>
          <div>
            ...
            <input type="password" className='bg-[#f4f4f5] p-3 px-6 w-[12rem] sm:w-[27rem] cursor-pointer my-2 outline-none rounded-xl shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] placeholder:text-black font-semibold' placeholder='Enter Password'/>   
          </div>  
